...
from .views import (
    ...
    MonthlyProductionReportView, DailyProductionReportView, YearlyProductionReportView,
...
urlpatterns = [
    ...
    path('yearly-production/', YearlyProductionReportView.as_view(), name='report_yearly'),
